...
const sqlite3InitModule = (() => {
  ...
  return (
    function (config) {
      const sqlite3InitModule = config || {}

      'use strict'

      const Module = typeof sqlite3InitModule != 'undefined' ? sqlite3InitModule : {}
      ...
      Module[xNameOfInstantiateWasm] = function callee(imports, onSuccess) {
        ...
        const uri = Module.locateFile(
          callee.uri, (
          (typeof scriptDirectory === 'undefined')
            ? ''
            : scriptDirectory),
        )
      ...
      function getBinaryPromise() {
        ...
        return Promise.resolve().then(() => { return getBinary(wasmBinaryFile) })
      }
      ...
      var FS = {
        ...
        createLazyFile: (parent, name, url, canRead, canWrite) => {
          ...
          LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
            ...
            lazyArray.setDataGetter((chunkNum) => {
              ...
              if (typeof lazyArray.chunks[chunkNum] == 'undefined') { throw new TypeError('doXHR failed!') }
        ...
        saveFilesToDB: (paths, onload, onerror) => {
          ...
          openRequest.onsuccess = () => {
            ...
            let ok = 0; let fail = 0; const total = paths.length
            function finish() {
      ...
      const __MONTH_DAYS_LEAP_CUMULATIVE = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335]

      const __MONTH_DAYS_REGULAR_CUMULATIVE = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]
      function __yday_from_date(date) {
        const isLeapYear = __isLeapYear(date.getFullYear())
        const monthDaysCumulative = (isLeapYear ? __MONTH_DAYS_LEAP_CUMULATIVE : __MONTH_DAYS_REGULAR_CUMULATIVE)
        const yday = monthDaysCumulative[date.getMonth()] + date.getDate() - 1

        return yday
      }
      function __localtime_js(time, tmPtr) {
        const date = new Date(readI53FromI64(time) * 1000)
        ...
        const yday = __yday_from_date(date) | 0
      ...
      let _emscripten_get_now; _emscripten_get_now = () => performance.now()
      ...
      Module.postRun.push((Module) => {
        ...
        self.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(
          ...
          const __isInt = n => typeof n === 'number' && n === (n | 0)
          ...
          const __SAB = (typeof SharedArrayBuffer === 'undefined')
            ? function () { }
            : SharedArrayBuffer
          ...
          const util = {
            ...
            isSharedTypedArray,
            toss(...args) { throw new Error(args.join(' ')) },
            toss3,
            typedArrayPart,
          }
          ...
          capi.sqlite3_randomness = (...args) => {
            if (args.length === 1 && util.isTypedArray(args[0])
              ...
              try {
                let n = ta.byteLength; let offset = 0
          ...
          if (false && wasm.exports.sqlite3_vfs_find(0) === 0) {
          ...
          capi.sqlite3_js_aggregate_context = (pCtx, n) => {
            return capi.sqlite3_aggregate_context(pCtx, n)
              || (n
                ? WasmAllocError.toss('Cannot allocate', n,
          ...
          capi.sqlite3_js_vfs_create_file = function (vfs, filename, data, dataLen) {
            ...
            try {
              ...
              if (rc) {
                SQLite3Error.toss('Creation of file failed with sqlite3 result code',
          ...
          if (util.isUIThread()) {
            const __kvvfsInfo = function (which) {
              ...
              rc.stores = []
              if (which === 'session' || which === '') { rc.stores.push(self.sessionStorage) }
              if (which === 'local' || which === '') { rc.stores.push(self.localStorage) }
              return rc
            }
          ...
          capi.sqlite3_column_js = function (pStmt, iCol, throwIfCannotConvert = true) {
            ...
            return (v === 0) ? undefined : capi.sqlite3_value_to_js(v, throwIfCannotConvert)
          }
        ...
        self.WhWasmUtilInstaller = function (target) {
          ...
          target.heapForSize = function (n, unsigned = true) {
            ...
            switch (n) {
              ...
              default:
                if (target.bigIntEnabled) {
                  if (n === self.BigUint64Array) { return c.HEAP64U } else if (n === self.BigInt64Array) { return c.HEAP64 }
                  break
                }
            }
          ...
          target.jsFuncToWasm = function f(func, sig) {
            ...
            if (sig[0] === 'v') { wasmCode.push(0) } else {
              wasmCode.push(1)
          ...
          target.peekPtr = (...ptr) => target.peek((ptr.length === 1 ? ptr[0] : ptr), ptrIR)
          ...
          target.isPtr32 = ptr => (typeof ptr === 'number' && (ptr === (ptr | 0)) && ptr >= 0)
          ...
          target.cstrToJs = function (ptr) {
            ...
            return n ? __utf8Decode(heapWrappers().HEAP8U, ptr, ptr + n) : (n === null ? n : '')
          }
          ...
          target.jstrcpy = function (jstr, tgt, offset = 0, maxBytes = -1, addNul = true) {
            ...
            let i = 0; const max = jstr.length
            const begin = offset; const end = offset + maxBytes - (addNul ? 1 : 0)
          ...
          const xArg = cache.xWrap.convert.arg; const xResult = cache.xWrap.convert.result

          if (target.bigIntEnabled) {
            xArg.set('i64', i => BigInt(i))
          }
          const __xArgPtr = ptrIR === 'i32'
            ? i => (i | 0)
            : i => (BigInt(i) | BigInt(0))
          ...
          const __xArgString = function (v) {
            if (typeof v === 'string') { return target.scopedAllocCString(v) }
          ...
          xResult.set('string', i => target.cstrToJs(i))
            ...
            .set('string:dealloc', (i) => {
              try { return i ? target.cstrToJs(i) : null } finally { target.dealloc(i) }
            })
            .set('utf8:dealloc', xResult.get('string:dealloc'))
            .set('json', i => JSON.parse(target.cstrToJs(i)))
            .set('json:dealloc', (i) => {
              try { return i ? JSON.parse(target.cstrToJs(i)) : null } finally { target.dealloc(i) }
            })
          ...
          xArg.FuncPtrAdapter = class FuncPtrAdapter extends AbstractArgAdapter {
            constructor(opt) {
              ...
              if (!FuncPtrAdapter.bindScopes.includes(opt.bindScope)) {
              ...
              if (v instanceof Function) {
                ...
                if (pair) {
                  if (pair[1]) {
                    ...
                    try { target.uninstallFunction(pair[1]) } catch (e) { }
                  }
                  pair[0] = v
                  pair[1] = fp
                }
                return fp
              } else if (target.isPtr(v) || v === null || undefined === v) {
                ...
                throw new TypeError('Invalid FuncPtrAdapter argument type. '
                  + `Expecting a function pointer or a ${this.name ? `${this.name} ` : ''
                  }function matching signature ${this.signature}.`)
              }
            }
          }
          ...
          cache.xWrap.convertResult
            = (t, v) => (t === null ? v : (t ? __xResultAdapterCheck(t)(v) : undefined))
          cache.xWrap.convertResultNoCheck
            = (t, v) => (t === null ? v : (t ? xResult.get(t)(v) : undefined))
          ...
          target.xWrap = function (fArg, resultType, ...argTypes) {
            ...
            if ((resultType === null) && xf.length === 0) {
              return xf
            }

            if (undefined !== resultType && resultType !== null) { __xResultAdapterCheck(resultType) }
          ...
          const __xAdapter = function (func, argc, typeName, adapter, modeName, xcvPart) {
            if (typeof typeName === 'string') {
              if (argc === 1) { return xcvPart.get(typeName) } else if (argc === 2) {
                if (!adapter) {
        ...
        self.Jaccwabyt = function StructBinderFactory(config) {
          ...
          const bigIntEnabled = (undefined === config.bigIntEnabled
            ? !!self.BigInt64Array
            : !!config.bigIntEnabled)
          const BigInt = self.BigInt
          const BigInt64Array = self.BigInt64Array
            ...
            SBF.__makeDebugFlags = function (deriveFrom = null) {
              ...
              const f = function f(flags) {
                ...
                if (flags < 0) {
                  ...
                  f.__flags.getter = (0x01 & flags) !== 0
                  f.__flags.setter = (0x02 & flags) !== 0
                  f.__flags.alloc = (0x04 & flags) !== 0
                  f.__flags.dealloc = (0x08 & flags) !== 0
                }
                return f._flags
              }
            ...
            if (m) {
              ...
              if (Array.isArray(obj.ondispose)) {
                ...
                while ((x = obj.ondispose.shift())) {
                  try {
                    if (x instanceof Function) { x.call(obj) } else if (x instanceof StructType) { x.dispose() } else if (typeof x === 'number') { dealloc(x) }
                  } catch (e) {
          ...
          const __ptrPropDescriptor = {
            configurable: false,
            enumerable: false,
            get() { return __instancePointerMap.get(this) },
        ...
        self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
          ...
          const capi = sqlite3.capi; const wasm = sqlite3.wasm; const util = sqlite3.util
          ...
          if (wasm.bigIntEnabled && !!wasm.exports.sqlite3changegroup_add) {
            const __ipsProxy = {
              ...
              callProxy: (callback) => {
                return (p, s) => {
                  try { return callback(p, wasm.cstrToJs(s)) | 0 } catch (e) { return e.resultCode || capi.SQLITE_ERROR }
                }
              },
            }
          ...
          __dbCleanupMap.cleanup = function (pDb) {
            ...
            for (const name of [
              ...
              try { capi[name](...closeArgs) } catch (e) {
            ...
            for (i = 0; i < 2; ++i) {
              ...
              for (const e of fmap) {
                const name = e[0]; const arities = e[1]
                const fargs = [pDb, name, 0, capi.SQLITE_UTF8, 0, 0, 0, 0, 0]
                if (i) { fargs.push(0) }
                for (const arity of arities) {
                  try { fargs[2] = arity; func.apply(null, fargs) } catch (e) { }
                }
                arities.clear()
              }
              fmap.clear()
...

          {
            ...
            capi.sqlite3_close_v2 = function (pDb) {
              if (arguments.length !== 1) { return __dbArgcMismatch(pDb, 'sqlite3_close_v2', 1) }
              if (pDb) {
...

          {
            ...
            capi.sqlite3_create_collation_v2 = function (pDb, zName, eTextRep, pArg, xCompare, xDestroy) {
              if (arguments.length !== 6) { return __dbArgcMismatch(pDb, 'sqlite3_create_collation_v2', 6) } else if ((eTextRep & 0xF) === 0) {
...

          {
            ...
            const __cfProxy = Object.assign(Object.create(null), {
              xInverseAndStep: {
                ...
                callProxy: (callback) => {
                  return (pCtx, argc, pArgv) => {
                    try { callback(pCtx, ...capi.sqlite3_values_to_js(argc, pArgv)) } catch (e) { capi.sqlite3_result_error_js(pCtx, e) }
                  }
                },
              },
              xFinalAndValue: {
                ...
                callProxy: (callback) => {
                  return (pCtx) => {
                    try { capi.sqlite3_result_js(pCtx, callback(pCtx)) } catch (e) { capi.sqlite3_result_error_js(pCtx, e) }
                  }
                },
              },
              xFunc: {
              ...
              xDestroy: {
                ...
                callProxy: (callback) => {
                  return (pVoid) => {
                    try { callback(pVoid) } catch (e) { console.error('UDF xDestroy method threw:', e) }
                  }
                },
              },
            })
            ...
            capi.sqlite3_create_function_v2 = function f(
              ...
              try {
                ...
                if (rc === 0 && (xFunc instanceof Function
            ...
            capi.sqlite3_create_window_function = function f(
              ...
              try {
                const rc = __sqlite3CreateWindowFunction(pDb, funcName, nArg, eTextRep,
                  ...
                  xInverse, xDestroy)
                if (rc === 0 && (xStep instanceof Function
                  || xFinal instanceof Function
...

          {
            ...
            capi.sqlite3_bind_blob = function f(pStmt, iCol, pMem, nMem, xDestroy) {
              ...
              } else if (wasm.isPtr(pMem) || pMem === null) {
...

          {
            ...
            capi.sqlite3_auto_extension = function (fPtr) {
              ...
              if (fPtr !== arguments[0]) {
                if (rc === 0) { __autoExtFptr.add(fPtr) } else { wasm.uninstallFunction(fPtr) }
              }
              return rc
            }
              ...
              const kvvfsImpls = {
                xRead: (zClass, zKey, zBuf, nBuf) => {
                  ...
                  try {
                    ...
                    if (!jV) { return -1 }
                    const nV = jV.length
                    if (nBuf <= 0) { return nV } else if (nBuf === 1) {
                      wasm.poke(zBuf, 0)
                      return nV
                    }
        ...
        self.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
        ...
        self.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
          ...
          const dbCtorHelper = function ctor(...args) {
            ...
            let fn = opt.filename; let vfsName = opt.vfs; const flagsStr = opt.flags
            if ((typeof fn !== 'string' && typeof fn !== 'number')
              || typeof flagsStr !== 'string'
              || (vfsName && (typeof vfsName !== 'string' && typeof vfsName !== 'number'))) {
              sqlite3.config.error('Invalid DB ctor args', opt, arguments)
              toss3('Invalid arguments for DB constructor.')
            }
            let fnJs = (typeof fn === 'number') ? wasm.cstrToJs(fn) : fn
            const vfsCheck = ctor._name2vfs[fnJs]
            if (vfsCheck) {
              vfsName = vfsCheck.vfs
              fn = fnJs = vfsCheck.filename(fnJs)
            }
            let pDb; let oflags = 0
            if (flagsStr.includes('c')) {
              oflags |= capi.SQLITE_OPEN_CREATE | capi.SQLITE_OPEN_READWRITE
            }
            if (flagsStr.includes('w')) { oflags |= capi.SQLITE_OPEN_READWRITE }
            if (oflags === 0) { oflags |= capi.SQLITE_OPEN_READONLY }
            oflags |= capi.SQLITE_OPEN_EXRESCODE
            const stack = wasm.pstack.pointer
            try {
              const pPtr = wasm.pstack.allocPtr()
              const rc = capi.sqlite3_open_v2(fn, pPtr, oflags, vfsName || 0)
              ...
              switch ((undefined === opt.rowMode)
                ...
                default:
                  if (util.isInt32(opt.rowMode)) {
                    ...
                    break
                  } else if (typeof opt.rowMode === 'string'
          ...
          DB.prototype = {
            ...
            close() {
              if (this.pointer) {
                if (this.onclose && (this.onclose.before instanceof Function)) {
                  try { this.onclose.before(this) } catch (e) { }
                }
                ...
                if (this.onclose && (this.onclose.after instanceof Function)) {
                  try { this.onclose.after(this) } catch (e) { }
                }
            ...
            dbVfsName(dbName = 0) {
              ...
              if (pVfs) {
                ...
                try { rc = wasm.cstrToJs(v.$zName) } finally { v.dispose() }
              }
              return rc
            },
            ...
            createFunction: function f(name, xFunc, opt) {
              ...
              const arityArg = (typeof arity === 'number'
                ? arity
            ...
            selectValues(sql, bind, asType) {
              const stmt = this.prepare(sql); const rc = []
              try {
                stmt.bind(bind)
          ...
          const isSupportedBindType = function (v) {
            const t = BindTypes[(v === null || undefined === v) ? 'null' : typeof v]
            switch (t) {
          ...
          const bindOne = function f(stmt, ndx, bindType, val) {
            ...
            let rc = 0
            switch ((val === null || undefined === val) ? BindTypes.null : bindType) {
              case BindTypes.null:
              ...
              case BindTypes.number: {
                let m
                if (util.isInt32(val)) { m = capi.sqlite3_bind_int } else if (typeof val === 'bigint') {
          ...
          Stmt.prototype = {
            ...
            get(ndx, asType) {
              ...
              switch (undefined === asType
                ...
                case capi.SQLITE_BLOB: {
                  ...
                  if (n && Array.isArray(this.db._blobXfer)) {
            ...
            getInt(ndx) { return this.get(ndx, capi.SQLITE_INTEGER) },

            getFloat(ndx) { return this.get(ndx, capi.SQLITE_FLOAT) },

            getString(ndx) { return this.get(ndx, capi.SQLITE_TEXT) },

            getBlob(ndx) { return this.get(ndx, capi.SQLITE_BLOB) },
          ...
          sqlite3.initWorker1API = function () {
            ...
            const wState = {
              ...
              open(opt) {
                ...
                if (!this.dbList.includes(db)) { this.dbList.push(db) }
                return db
              },
              close(db, alsoUnlink) {
                if (db) {
            ...
            const wMsgHandler = {
              'open': function (ev) {
                const oargs = Object.create(null); const args = (ev.args || Object.create(null))
              ...
              'close': function (ev) {
                ...
                if (db) {
                  const doUnlink = ((ev.args && typeof ev.args === 'object')
                    ? !!ev.args.unlink
                    : false)
              ...
              'config-get': function () {
                const rc = Object.create(null); const src = sqlite3.config;
                [
                  'bigIntEnabled',
                ].forEach((k) => {
            ...
            self.onmessage = async function (ev) {
              ev = ev.data
              let result; let dbId = ev.dbId; let evType = ev.type
              ...
              try {
                ...
                if (err.stack) {
                  result.stack = (typeof err.stack === 'string')
                    ? err.stack.split(/\n\s*/)
                    : err.stack
                }
                if (0) {
                  sqlite3.config.warn('Worker is propagating an exception to main thread.',
        ...
        'use strict'
        self.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
          const wasm = sqlite3.wasm; const capi = sqlite3.capi; const toss = sqlite3.util.toss3
          const vfs = Object.create(null); const vtab = Object.create(null)
              ...
              callee.removeFuncList = function () {
                if (this.ondispose.__removeFuncList) {
                  this.ondispose.__removeFuncList.forEach(
                    (v, ndx) => {
                      if (typeof v === 'number') {
                        try { wasm.uninstallFunction(v) } catch (e) { }
                      }
                    },
                  )
          ...
          vtab.xError = function f(methodName, err, defaultRc) {
            if (f.errorReporter instanceof Function) {
              try { f.errorReporter(`sqlite3_module::${methodName}(): ${err.message}`) } catch (e) { }
            }
            let rc
          ...
          vtab.setupModule = function (opt) {
            ...
            try {
              ...
              for (const e of Object.entries({
                ...
                if (methods[k] === true) { methods[k] = methods[v] } else if (methods[v] === true) { methods[v] = methods[k] }
              }
              if (opt.catchExceptions) {
                const fwrap = function (methodName, func) {
                  if (['xConnect', 'xCreate'].includes(methodName)) {
                    return function (pDb, pAux, argc, argv, ppVtab, pzErr) {
                      try { return func(...arguments) || 0 } catch (e) {
                    ...
                    return function (...args) {
                      try { return func(...args) || 0 } catch (e) {
                        return vtab.xError(methodName, e)
                      }
                    }
                  }
                ...
                for (const k of mnames) {
                  const m = methods[k]
                  if (!(m instanceof Function)) { continue } else if (k === 'xConnect' && methods.xCreate === m) {
                    remethods[k] = methods.xCreate
                  } else if (k === 'xCreate' && methods.xConnect === m) {
              ...
              if (mod.$iVersion === 0) {
                let v
                if (typeof opt.iVersion === 'number') { v = opt.iVersion } else if (mod.$xShadowName) { v = 3 } else if (mod.$xSavePoint || mod.$xRelease || mod.$xRollbackTo) { v = 2 } else { v = 1 }
                mod.$iVersion = v
              }
            } catch (e) {
        ...
        self.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
          const installOpfsVfs = function callee(options) {
            ...
            const thePromise = new Promise((promiseResolve, promiseReject_) => {
              const loggers = {
              ...
              const initS11n = () => {
                ...
                state.s11n.deserialize = function (clear = false) {
                  ...
                  if (argc) {
                    const typeIds = []
                    let offset = 1; let i; let n; let v
              ...
              opfsUtil.rmfr = async function () {
                const dir = opfsUtil.rootDirectory; const opt = { recurse: true }
              ...
              opfsUtil.traverse = async function (opt) {
                ...
                const doDir = async function callee(dirHandle, depth) {
                  for await (const handle of dirHandle.values()) {
                    if (opt.callback(handle, dirHandle, depth) === false) { return false } else if (opt.recursive && handle.kind === 'directory') {
